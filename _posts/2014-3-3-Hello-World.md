...
* 먼저 static 함수에 대해 설명하겠습니다. 일반적으로 우리가 urls.py에서 작성하는 URL 경로들은 '웹페이지'의 경로들입니다. "home.html을 띄워주세요. 아, 템플릿 태그에서는 {% url 'home' %}으로 사용할 거니까 그렇게 해주세요." 와 같은 필요에 따라 작성하는 것입니다. 
